...
const ConferenceCard = ({ conference, onDelete, onStart, useMediasoup }) => {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                    ...
                    <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(conference.status)}`}
                    >
            ...
            <div className="space-y-2 mb-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>
                        {format(
                            new Date(conference.start_time),
                            "MMM dd, yyyy",
                        )}
                    </span>
                </div>
